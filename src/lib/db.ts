...
export function getKirbaiStatsBaseline() {
    return {
        ...
        distroKid: {
            ...
            topStores: (kirbaiStatsBaseline.distroKid.topStores || []).slice(0, 15),
            topTracks: (kirbaiStatsBaseline.distroKid.topTracks || []).slice(0, 25),
            topCountries: (kirbaiStatsBaseline.distroKid.topCountries || []).slice(0, 15),
