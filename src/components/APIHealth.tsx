        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="card p-10 relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-6 relative z-10">
                    ...
                    <div className="w-full h-4 bg-surface/40 rounded-full overflow-hidden border border-border relative">
                        <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card p-8 flex flex-col gap-4">
                    <span className="section-subtitle text-foreground/50">Lifetime Input Tokens</span>
                    <span className="stat-value">{telemetry.lifetimeInputTokens.toLocaleString()}</span>
                    <span className="text-[9px] font-mono text-foreground/40">$0.10 per 1M (Gemini 2.0 Flash)</span>
                </div>
                <div className="card p-8 flex flex-col gap-4">
                    <span className="section-subtitle text-foreground/50">Lifetime Output Tokens</span>
                    <span className="stat-value">{telemetry.lifetimeOutputTokens.toLocaleString()}</span>
            ...
            <div className="card p-8 flex flex-col gap-6">
                <div className="flex justify-between items-center pb-4 border-b border-border">
                    <span className="section-subtitle text-foreground/80">Network Transmission Log</span>
